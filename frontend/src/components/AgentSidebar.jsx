    ...
    >
      ...
      <div className="p-3">
        {isCollapsed ? (
          ...
          <button
            onClick={onOpenCreateSession}
            className="w-full py-2 px-3 rounded-md bg-zinc-100 text-zinc-950 hover:bg-white flex items-center justify-center gap-2 text-xs font-medium transition-colors"
          >
            <Plus className="w-4 h-4" />
            New Session
          </button>
        ...
        {filteredSessions.length === 0 ? (
          ...
          filteredSessions.map((session) => {
            ...
            return (
              ...
              >
                <MessageSquare className={`w-4 h-4 flex-shrink-0 ${isSelected ? "text-white" : "text-zinc-500"}`} />
                ...
                {!isCollapsed && (
                  <button
                    ...
                    className="opacity-0 group-hover:opacity-100 p-1 text-zinc-500 hover:text-zinc-200 hover:bg-zinc-700/50 rounded transition-all absolute right-1.5"
